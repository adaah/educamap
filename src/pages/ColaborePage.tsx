                  ...
                  <div className="p-8">
                    <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                      ...
                      <div className="flex-shrink-0">
                        <div className="p-4 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl text-primary group-hover:scale-110 transition-transform duration-300">
                          {icons[index]}
                        </div>
                      </div>
                      ...
                      <div className="flex-1 space-y-3">
                        <h3 className="font-poppins font-bold text-2xl text-foreground group-hover:text-primary transition-colors">
                          {option.title}
                        </h3>
