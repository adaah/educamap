...
export const mockSchools: School[] = [
  {
    id: '1',
    name: 'Colégio Estadual Heitor Villa Lobas',
    neighborhood: 'Federação',
    fullAddress: 'Av. Test Villa Lobas, 123 - Federação, Salvador - BA',
    coordinates: [-38.440513, -12.954830],
  ...
  {
    id: '2',
    name: 'Colégio Estadual Gesino Coelho',
    neighborhood: 'Federação',
    fullAddress: 'Rua Test Gesino, 456 - Federação, Salvador - BA',
    coordinates: [-38.443024, -12.957026],
